...
Understand that this is work in progress and kind of experimental, I don't have access to a complete test suite of unit tests to rigorously test this, I nevertheless feel it can be useful for folks to at least know about this option to run [XSLT 3.0](https://www.w3.org/TR/xslt-30/), [XPath 3.1](https://www.w3.org/TR/xpath-31/) and [XQuery 3.1](https://www.w3.org/TR/xquery-31/) in .NET 8 or .NET 9 or .NET 10 code or .NET framework 4.8 code.
...
```
  <ItemGroup>
    <PackageReference Include="IKVM.Maven.Sdk" Version="1.10.0" />
    <PackageReference Include="SaxonHE12s9apiExtensions" Version="12.9.10-pre1" />
