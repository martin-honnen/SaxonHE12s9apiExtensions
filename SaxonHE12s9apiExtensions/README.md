...
With this new release based on IKVM 8.12.0 and IKVM.Maven.Sdk 1.9.3 IKVM uses an up to date Java 8/1.8 JDK 8u452-b09, as for .NET, both using and building the package on Windows (including Windows ARM) and MacOs should work.
...
```
  <ItemGroup>
    <PackageReference Include="IKVM.Maven.Sdk" Version="1.9.3" />
    <PackageReference Include="SaxonHE12s9apiExtensions" Version="12.8.0" />
